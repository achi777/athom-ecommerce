...
class Controller extends init
{
    ...
    public function add_post()
    {
        ...
        if($catID > 0){
            ...
            $data['visible'] = "style=\"display: none;\"";
        }

        //easy::out($data['productDetails']);
        if (!empty($this->input->post("addPost"))) {
            ...
            $this->model->infoToBase($this->input->post("titleGeo"), $this->input->post("titleEng"), $this->input->post("titleRus"), $this->input->post("descriptionGeo"), $this->input->post("descriptionEng"), $this->input->post("descriptionRus"), $this->input->post("detailsGeo"), $this->input->post("detailsEng"), $this->input->post("detailsRus"), $catID, $postDate, $photo);


            $_POST = array();
            //$this->helper->redirect(baseurl . "/admin/edit_post/" . $post_id);
        }
