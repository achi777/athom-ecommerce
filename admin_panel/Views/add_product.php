...
<div class="content-wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <h3 class="page-title">პროდუქცია <small> პროდუქციის დამატება </small></h3>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-block">
                ...
                <fieldset class="content-group">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group row margin-top-10">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="product_name_geo">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="product_name_rus">
                            </div>
                        </div>
                ...
                <fieldset class="content-group">
                    ...
                    <div class="form-group row margin-top-10">
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="ფასი" name="product_price" aria-describedby="basic-addon1">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row margin-top-10">
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                <span class="input-group-addon" id="basic-addon1"><i class="lari lari-bolder"></i></span>
                                <input type="text" class="form-control" placeholder="ფასდაკლები" name="product_sale" aria-describedby="basic-addon1">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-block text-center">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="geo" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-geo" name="product_desc_geo"></textarea>
                            </div>
                            <div class="tab-pane" id="eng" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-eng" name="product_desc_eng"></textarea>
                            </div>
                            <div class="tab-pane" id="rus" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-rus" name="product_desc_rus"></textarea>
                            </div>
                        </div>
                    </div>
                </fieldset>
                    ...
                    <div class="card-block text-center">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="geoFull" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-full-geo" name="product_full_geo"></textarea>
                            </div>
                            <div class="tab-pane" id="engFull" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-full-eng" name="product_full_eng"></textarea>
                            </div>
                            <div class="tab-pane" id="rusFull" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-full-rus" name="product_full_rus"></textarea>
                            </div>
                        </div>
                    </div>
                </fieldset>
                ...
                <legend class="text-bold">აირჩიეთ ფოტო (600x600) შემდეგ დააკლიკეთ "შენახვა" - ს </legend>
                <fieldset class="content-group">
