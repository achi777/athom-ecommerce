        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <@foreach($postCats AS $item):@>
                    <a class="btn btn-primary" href="{{baseurl}}/admin/edit_post/{{$postID}}/{{$item->cat_id}}">{{$item->cat_name_geo}}</a>
                <@endforeach@>
            </div>
        </div>
                ...
                <fieldset class="content-group">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group row margin-top-10">
                            ...
                            <div class="col-md-10">
                                <input type="text" value="{{$post[0]->title_geo}}" class="form-control" name="titleGeo">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" value="{{$post[0]->title_eng}}" class="form-control" name="titleEng">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" value="{{$post[0]->title_rus}}" class="form-control" name="titleRus">
                            </div>
                        </div>
                    ...
                    <div class="card-block text-center">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="geo" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-geo" name="descriptionGeo">{{$post[0]->description_geo}}</textarea>
                            </div>
                            <div class="tab-pane" id="eng" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-eng" name="descriptionEng">{{$post[0]->description_eng}}</textarea>
                            </div>
                            <div class="tab-pane" id="rus" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-rus" name="descriptionRus">{{$post[0]->description_rus}}</textarea>
                            </div>
                        </div>
                    </div>
                </fieldset>
                    ...
                    <div class="card-block text-center">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="geoFull" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-full-geo" name="detailsGeo">{{$post[0]->details_geo}}</textarea>
                            </div>
                            <div class="tab-pane" id="engFull" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-full-eng" name="detailsEng">{{$post[0]->details_eng}}</textarea>
                            </div>
                            <div class="tab-pane" id="rusFull" role="tabpanel">
                                <textarea class="form-control" rows="5" id="editor-full-rus" name="detailsRus">{{$post[0]->details_rus}}</textarea>
                            </div>
                        </div>
                    </div>
                </fieldset>

                <legend class="text-bold">ფოტო</legend>
                <fieldset class="content-group">
                    <div class="row" style="margin-top: 40px!important;">
                        <img src="{{baseurl}}/assets/images/blog/{{$post[0]->photo}}" width="100px;">
                    </div>
                </fieldset>
                    ...
                    <div class="form-group row margin-top-10">
                        <div class="col-md-10">
                            <div class="input-group">
                                <input type="submit" class="btn btn-success" value="შენახვა" name="editPost">
