          ...
          <div class="col-lg-8">
            <div class="checkout-steps-form-style-1">
              <ul id="accordionExample">
                <li>
                  <h6 class="title" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Your Personal Details </h6>
                ...
                <li>
                  <h6 class="title collapsed" data-bs-toggle="collapse" data-bs-target="#collapsesix" aria-expanded="true" aria-controls="collapsesix">My Orders</h6>
                  <section class="checkout-steps-form-content collapse show" id="collapsesix" aria-labelledby="headingsix" data-bs-parent="#accordionExample">
                        <div class="row">
                        <!--Orders-->                
                                ...
                                <div class="order my-3 bg-light">
                                    <div class="row">
                                        ...
                                        <div class="d-flex flex-column justify-content-between order-summary">
                                            ...
                                            <div class="text-uppercase">ORDER # {{$item->order_code}}</div>
                                        ...
                                        <div class="d-sm-flex align-items-sm-start justify-content-sm-between">
                                            ...
                                            <a href="{{baseurl}}/order_products/{{$item->order_code}}" class="btn btn-primary text-uppercase col-md-4">Products</a>
